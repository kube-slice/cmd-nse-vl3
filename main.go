...
type Config struct {
	Name                  string            `default:"vl3-slice-router" desc:"Name of vl3 Server"`
	BaseDir               string            `default:"./" desc:"base directory" split_words:"true"`
	ConnectTo             url.URL           `default:"unix:///var/lib/networkservicemesh/nsm.io.sock" desc:"url to connect to" split_words:"true"`
	MaxTokenLifetime      time.Duration     `default:"600m" desc:"maximum lifetime of tokens" split_words:"true"`
	ServiceNames          []string          `default:"vl3-slice-router" desc:"Name of provided services" split_words:"true"`
	Payload               string            `default:"ETHERNET" desc:"Name of provided service payload" split_words:"true"`
	Labels                map[string]string `default:"" desc:"Endpoint labels"`
	DNSConfigs            dnsconfig.Decoder `default:"[]" desc:"DNSConfigs represents array of DNSConfig in json format" split_words:"true"`
	Vl3Prefix             string            `default:"169.254.0.0/16" desc:"List of CIDR Prefix to assign IPv4 and IPv6 addresses from" split_words:"true"`
...
func main() {
	...
	log.FromContext(ctx).Infof("3: create vl3 server nse")
